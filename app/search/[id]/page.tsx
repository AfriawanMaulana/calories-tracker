      ...
      <div className="group cursor-pointer relative overflow-hidden rounded-2xl">
        {data?.food?.food_images?.food_image && (
          <Image
            ...
            height={200}
            loading="eager"
            className="object-center w-full h-52 object-cover rounded-2xl brightness-75 group-hover:brightness-90 group-hover:scale-105 transition-all ease-in-out duration-200"
          />
        )}
        <h1 className="absolute bottom-0 left-0 p-2 text-start font-bold text-3xl text-white line-clamp-1">
          {data?.food.food_name}
        </h1>
      </div>
